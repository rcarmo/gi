...
export default defineConfig({
  testDir: './tests/ux', testMatch: ['classic.spec.mjs', 'session.spec.mjs', 'drafts.spec.mjs', 'queue.spec.mjs', 'models.spec.mjs', 'context.spec.mjs', 'queue-return.spec.mjs'], timeout: 30000,
