...
| Queue | On-demand `/queue` pages six durable rows; guarded removal by turn ID and Steer by queued/active IDs. | No queue reorder/retry UI or persisted queued text drafts; Stop-policy differences remain. |
