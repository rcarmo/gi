...
- [ ] Complete fullscreen application selection/copy/edge autoscroll, per-occurrence/cross-wrap search and clickable controls; light theme and retained-output/reflow/oversized-editor limits also need evidence.
