...
- [ ] P1 remaining delivery: routed/steering/legacy ack gaps, six-budget/late receipts, bounded native receipt endpoint and cross-tab IndexedDB ownership. Keep unknown outcomes explicit; never infer from prompt text or auto replay.
