...
- [x] Shared38 web mapping verified8196355 after wholeCI36265284691 firstattempt/all4builds. Exact100cap/tail + reversedmulti-anchor/context union/window/bytebounds/missingforeign/quoteddata combined6project proof; review initially withheld then stronger assertions approved.33/42shared,Classic101/236 unchanged. Local6browser/race×3/9helpers1969assertions/core/vet/hooks pass. Runtime source unchanged vs deployed05e287f,PID776843/PGID776835;no restart/migration/livewrites. [Evidence](../internal/message-retrieval.md#shared38-web-mapping).

- [x] Shared38 prerequisite deployed exact05e287f after wholeCI36263310102 firstattempt/all4builds. Durable AUTOINCREMENT map+atomic migration/trigger; runtime-session messages tool bounded100/context10/content2048/encoded80KB, timeline cursors/missing/truncation. Race×3,6browser+12repeat,139functional(11skips),core/vet/hooks pass; scoped review no blocker. PID776843/PGID776835;146 mappings correct,all pre-existing data/schema/sequences exceptlease unchanged,auth/WIP intact,DB62/51/146/0active.4blockedHTTP+6read-onlyUI pass,no livechatwrites. Shared38/Classic025 still unmapped; fullscenario and allchat/family evidence separate. [Contract/deployment](../internal/message-retrieval.md).

- [x] Shared35 estimate/mapping: exactd415541 deployed after CI36259191352 attempt2/all4builds;PID668487/PGID668479. Native estimate provenance separate measuredusage,unknown/malformed omitted,noidleUI. Canonical6project clauseaudit accepted;36thinking/102compaction/18meter/6helpers62assertions/8report1963assertions/139functional(11skips)+core pass.32/42shared mapped,Classic101/236 unchanged.4blockedHTTP+6read-onlyUI pass,DB62/51/146SQL/auth/WIP unchanged,no livewrites. Stop fixture corrected after initialCI; unchangedWebKit rerun accepted with artifacts,no rootcausefix/timeouts relaxed. No TUI/physical/pixel credit. [Evidence](../internal/context-estimate-provenance.md).

- [x] Shared35 thinking prerequisite: catalogue-validated Settings/sessionCAS+revision, immutable admitted model-bound provider Reasoning, Default omitted, stale/foreign/unsupported rejects. Native race×3/30thinking/42modelpanel/108Settings/139functional(11skips)/36controls/core/vet pass;final review approved. InitialCI36254114983 reporthelper5s failed; all102subprocesses/assertions preserved across5independent tests,no timeout change. Exact53ef988 deployed after CI36254837868/newthinkingjob/all4builds;PID520574/PGID520566;4blockedHTTP+6read-onlyUI pass,DB62/51/146fullSQL/auth/WIP unchanged,no live writes. Shared35 still unmapped (estimate clause unresolved),TUIWIPisolated. [Contract](../internal/session-thinking.md).

- [x] Shared36 web Stop/queue preservation: exactcaa83c7 deployed after wholeCI36247821576/all4builds, PID312567/PGID312558. Durable hold/fenced Resume, unchanged generic/TUI cancel; launch failures retain hold, returnedSteer never auto-runs/traps hold. Native race×3/36HTTP/66reconnect/139functional(11skips)/core/vet passed;4blockedHTTP+6read-onlyUI probes,DB62/51/146 SQL/auth/WIP unchanged,no live chat writes. Independent clause review accepted; canonical @shared-36 tag+catalogue/report gate now maps31/42shared (Classic101/236 unchanged).66tagged reconnect and3reporthelpers1954assertions pass; focused report1sharedpass/30not-run/11unmapped. No TUI/physical/pixel credit. [Contract/evidence](../internal/web-stop-queue.md).
...
- [x] P1 login cancellation: deterministic held-request/held-response regressions failed old Cancel UI6/6 then pass6/6; phase-owned cancellation only during credentials.get, start/finish stay single-flight busy, synchronous stale-button guard, late-start abort check. Repeat27/fullpasskeys195/auth120/functional129(11skips)/helpers8+1661assertions/core/vet/hooks pass; review no blocker. Exact a1be540 deployed after whole-product CI36241463237 incl4builds, PID74444/PGID74437;4blockedHTTP+6read-onlyUI pass, full SQL/auth/WIP unchanged, DB62/51/146 clean. No live chat/auth writes. Settings cancellation and physical OS-sheet acceptance separate. [Boundary/evidence](../internal/passkey-login-cancellation.md).
- [x] P1 cross-tab draft fencing: atomic per-session revision CAS freezes stale writes/sends, retains local edits and refuses stale recovery before publishing; IndexedDBv2 fences old unconditional writers. No automatic merge/retry, full reload required after conflict/load failure; unknown-first/accepted-later remains unknown. Red2regressions then24helpers119assertions/32HTTPtwo-browser/139functional(11skips)/24controls/168drafts/18queue-return/core/vet/hooks pass; final review accepts bounded scope. Deployed exact9c01b5d after wholeCI36244076781 incl4builds,PID192481/PGID192474;4blockedHTTP+6read-onlyUI pass,fullSQL/auth/WIP unchanged,DB62/51/146 clean. No live chat writes. Copy unsaved old-tab edits before reload; no version1 rollback after migration. [Contract and limits](../internal/web-cross-tab-drafts.md); evidence `/workspace/tmp/gi-cross-tab`.
...
- [x] P1 closed-page same-session recovery: persisted capturetoken sent idle/queue; startup checks max6captures/twoworkers/3s deadline,exact same-session token+submitted audit only,awaitscleanupwrite. RealHTTP single-forwardproxy close/reopen tests preserve newer draft/retire accepted attachments,unknown reads warn/noPOST.18HTTP+18control/model+17helpers68assertions+125functional(11skips)+core/vet/hooks pass;reviewtimeouts not approval. [Scope](../internal/web-delivery-recovery.md#reopening-before-acknowledgement);CI/deploy pending,no general exactly-once.
- [x] P1 bounded native send receipt: source-session/token lookup records successful local/routed/steered native results; indexed GET reads at most two rows, duplicates/missing stay unknown. Browser uses receipts without history scans or POST replay. Local gates passed: race×3, 22 HTTP journeys, 24 controls, 16 helpers/65 assertions, 129 functional tests (11 existing skips), core/vet/hooks. Source d62967f passed whole-product CI 36236155040 attempt 2 including all four builds; initial WebKit static-loading failure retained, unchanged local 36-case compose reproduction passed. Deployed exact d62967f after post-reboot clearance: PID11493/PGID11486 on8090; 4blocked HTTP sends+6read-only UI probes pass, DB62/51/146 unchanged, auth/integrity clean. No live chat writes. Crash-before-receipt, legacy, late, over-budget and cross-tab uncertainty remain explicit. See [receipt contract and evidence](../internal/web-send-receipts.md).
...
- [x] Add unwired paired text/media journal: atomic claim/settlement/explicit rejected restore-discard, reciprocal markers block single-API release, same-receipt tokens/no ambiguous replay; newer drafts/refs and sixcap preserved. Race×3rollback/reopen/two-client/receipt/legacyAPI/refguards+media/core/vet/hooks+107functional(11skips)pass;focusedreview no blocker. [Contract](../internal/tui-text-journal.md#paired-text-and-media-prerequisite);CI/deploy separate.
- [x] Add unwired native stored-composer submission: durable one-caller dispatch/revision fence, stored text/media only, read-only route preview rejects cross-agent; public text+media tokens stripped before steering/turn, existing mediaTUI uses validated adapter. Race×3/twoengine/restart/forgery/fault/newer-edit tests+12media/retryPTY+107functional(11skips)+core/vet/hooks pass; shared-memory ClearTurnFailure upgrade deadlock fixed,concurrentrace×10 pass. [Contract](../internal/tui-text-journal.md#engine-submission-and-token-ownership);review finding fixed,rereviewtimeout,no finalindependentapproval. CI/deploy pending.
- [ ] Wire frontend autosave/session-visit/CAS callbacks and explicit held-draft recovery to validated paired/engine APIs; prove crashPTYs without replay/idle chrome. Cross-session durable routing unsupported; accepted-work queued recall separate.
...
- [x] Add version-one atomic held-retry admission: follow-on/subturn/resolution/phase/queue-count commit together; lost replies return storedID without audit dependency. Explicit session+token release fences paused old owners, never submits; legacy version-zero remains blocked. Race×3 includes eight two-connection release/admission races, rollback/audit-loss/reopen/schema/public-metadata guards; core/vet/hooks+107functional(11skips) and focused review pass. [Contract](../internal/held-turn-retry.md); CI/deploy pending,no UI.
- [x] Expose `/retry [page]`, `check <id>`, `run <id>`, `release <id> <token>` with six advisory rows/fullIDs, native session guards and no idle chrome. Read-only checks, release never submits, legacy ambiguity blocked. Race×3/core/vet/hooks+sixretry/ninequeue-regularPTYs+107functional(11skips) pass; narrow guidance clipping and shutdown nil-context panic fixed/tested. Required PTY CI gate added; [contract/evidence](../internal/tui-held-retry.md). CI/deploy pending; no browser mapping/physical credit, mixed-version writers unsupported.
...
- [x] Implement/test host-only browser voice event contract: secure capability+gesture gating/iOSdictation fallback,captured session/draft and cumulative transcripts,modal/search/hide/unmount/manual-edit cancellation,bounded15/5/90s lifecycle,noautosend. Eighthelpers/30voice/30compose/72slash/56phone-draft/107functional(11skips),Go/vet/hooks/14pixelhelpers pass. Real mic/nativeprompt/physical unverified,noformal mapping;TUIusesOSdictation/paste with noidle row. 72captures still18crossfail+12/36repeatunstable. See [voice input](../internal/voice-input.md);awaitCI/deployment.
- [x] Implement/test browser-scoped opt-in local notifications: secureAPI+WebLocks,visible-client suppression/hiddenleader,boundedverified dedupe,fresh reply filtering,generic body,logout lock barrier and retirement.10helpers/24native-SSE notification/120auth/30compose/72slash/107functional(11skips),Go-vet-hooks/14pixelhelpers pass;passkey phone/tablet completed before interruption,desktop63/63 separately.72captures still18crossfail+14/36repeatunstable,compose242–1048px. See [local notifications](../internal/local-notifications.md). WebPush/background/OSprompt/family/Visual unverified,noTUIchrome;awaitCI/deploy.
- [x] Implement the model-picker combobox/listbox contract: stable per-mount IDs, enabled active descendant distinct from current selection, accessible blocked descriptions and no option Tab stops. Disable cached-row activation during refresh; restore the trigger after selection without taking focus from composer/Settings. Eight model helpers, 36 panel, 36 context-fit, 24 geometry, 174 model/Quick Actions and 107 functional tests pass (11 existing skips); Go/vet/hooks and 14 pixel helpers pass. CI/deployment pending; screen-reader/physical and exact pixel acceptance remain open. See [model panel](../internal/model-panel.md#model-accessibility).
...
- [x] Shared36's former auto-advance blocker is resolved by durable web Stop/Resume and the mapped canonical reconnect proof above. Generic/TUI cancellation still advances.
- [x] Shared35 capability/estimate web evidence mapped and deployed in the combined canonical journey above; no terminal, physical-device or pixel acceptance added.
