...
- [ ] Implement remaining index integration: configured settings, bounded rooted scanner/chunker, lease-renewing incremental worker, invalidation/background refresh, lexical native query/status/reindex and independent terminal acceptance; keep provisional global rebuild stashed.
