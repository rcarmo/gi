...
- [ ] Gi Compaction (`gi-settings-014`–`017`): effective engine policy read-only, token-bound Compact, matching-turn Stop, authoritative progress during delayed POST, read/action failure and close/switch guards. Native six-project compaction 96/96, Settings/Models108/108, functional83/83, helpers43, Go/vet/build/hook/web-turn race×3 pass. No policy writes, unsupported Piclaw controls, frozen credit or TUI rows. Commit/deployment pending.
