...
- [ ] Complete fullscreen search, prompt jumps and application selection/copy/edge autoscroll; light theme and retained-output/reflow/oversized-editor limits also need evidence.
