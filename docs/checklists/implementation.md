...
- [ ] Complete fullscreen application selection/copy/edge autoscroll (saved patch/archive still has failing expanded tool-click case), per-occurrence/cross-wrap search and clickable controls; light theme and retained-output/reflow/oversized-editor limits also need evidence.
