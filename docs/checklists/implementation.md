...
- [ ] Map the remaining 221 frozen scenarios and all 42 shared interaction cases; full scope in `docs/internal/full-web-tui-parity-plan.md`.
...
- [ ] Complete durable queue-return/Steer and remaining reconnect ownership (separate acceptance evidence).
