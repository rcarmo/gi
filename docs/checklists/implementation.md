...
- [ ] Implement remaining index integration: application scheduling/invalidation/background refresh, query consumers and independent terminal acceptance; keep provisional global rebuild stashed.
