...
- [ ] Implement remaining index integration: configured settings/optional-root policy, application scheduling/invalidation/background refresh, query consumers and independent terminal acceptance; keep provisional global rebuild stashed.
