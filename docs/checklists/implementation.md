...
- [ ] Wire plaintext autosave only after UI callback/session-visit/CAS conflicts, claim token provenance/routing and crashPTYs are guarded; paired store primitives alone are not frontend persistence acceptance. Accepted-work queued recall remains separate.
