...
- [ ] Expose held-retry recovery only through session-bound full-ID native commands with explicit release/check semantics, legacy ambiguity explanation and bounded PTY acceptance; no idle rows or implicit replay. Mixed old/new database writers remain unsupported.
