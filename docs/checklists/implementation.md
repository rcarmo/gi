...
- [-] Shared38 prerequisite implemented locally: durable AUTOINCREMENT identities alongside UUIDs, atomic migration/trigger, runtime-session messages tool, bounded100/context10/content2048/encoded80KB, timeline cursors and truthful missing/truncation. Race×3/store/tool/native dispatch,6browser+12repeat,139functional(11skips),core/vet/hooks pass; scoped source review found no blocker. RequiredCI gate added; CI/deploy pending. Shared38/Classic025 remain unmapped; all-chat/family authorization and full scenario acceptance separate. [Contract](../internal/message-retrieval.md).
