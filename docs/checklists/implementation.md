...
- [ ] P1 continue basic workflow coverage: model selection → next turn, routed/closed-page acknowledgement recovery, bounded receipt lookup and stronger identity assertions in older tests. Do not treat same-session live-page recovery as general exactly-once delivery.
