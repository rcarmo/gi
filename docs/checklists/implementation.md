...
- [ ] Implement remaining index integration: external/shell/watch delivery, restart recovery, nonblocking background refresh, query consumers and independent terminal acceptance; keep provisional global rebuild stashed.
