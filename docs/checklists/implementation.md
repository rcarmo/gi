...
- [ ] Implement remaining index integration: watcher/mutation invalidation delivery, nonblocking background refresh, query consumers and independent terminal acceptance; keep provisional global rebuild stashed.
