...
- [ ] Thoughts001 wrapped disclosure: guarded build-time adapter + real collapsed scrollHeight/clientHeight, generic Show more (no invented counts), RO/font/stream/viewport and noRO ancestor fallback. Preview48/status12/functional85/helpers51/Go-vet-build-hook pass; Classic81/236+shared3/42 unmapped155/39; supplied sources unchanged. Commit/deploy pending; no TUI rows.
