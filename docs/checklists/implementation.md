...
- [ ] Implement remaining index integration: configured settings/optional-root policy, lease-renewing worker, invalidation/background refresh, lexical native query/status/reindex and independent terminal acceptance; keep provisional global rebuild stashed.
