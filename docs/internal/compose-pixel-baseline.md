...
The current cross-UI pixel gate fails. The full matrix captured 72 images with no route or page errors, but all 18 Gi/Piclaw comparisons differ and 13 of 36 same-host comparisons are unstable. Geometry tests and successful screenshot capture do not establish pixel parity.
