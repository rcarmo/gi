...
The current passkey suite has 47 tests in Chromium across three viewport projects
(141 executions). Two narrow-interaction tests explicitly create390px touch-capable
