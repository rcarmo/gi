...
The current passkey suite has 55 tests in Chromium across three viewport projects
(165 executions). Two narrow-interaction tests explicitly create390px touch-capable
