...
The current passkey suite has 48 tests in Chromium across three viewport projects
(144 executions). Two narrow-interaction tests explicitly create390px touch-capable
