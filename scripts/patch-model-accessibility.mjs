...
export function patchModelAccessibility(source){
 ...
 replace('<div class="compose-model-popup-menu compose-model-catalogue-results" role="menu" aria-label="Model picker">','<div id=${modelPanelIdRef.current + "-results"} class="compose-model-popup-menu compose-model-catalogue-results" role="listbox" aria-label="Models" aria-busy=${loadingModels ? "true" : "false"}>');
