@oracle-only @piclaw-3.2.3 @not-gi-parity
Feature: Observed basic Classic interactions in the shipped Piclaw 3.2.3 UI
  The oracle is the installed 3.2.3 release, not the older frozen 70d33bc
