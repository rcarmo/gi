...
function fixture(){
 ...
 const root={ownerDocument:doc,closest:()=>null},input={isConnected:true,focus:()=>focused++};
 ...
 return {cleanup,escape,frame:()=>frame(),opener,setInert:()=>inert=true,setModal:()=>modal=true,counts:()=>({canceled,closed,focused,restored})};
}
